...
namespace ET
{
	public class MyCodeLoader: IDisposable
	{
		public static MyCodeLoader Instance = new MyCodeLoader();
		...
		public void Start()
		{
			switch (this.CodeMode)
			{
				case CodeMode.Mono:
				{
					...
					IStaticMethod start = new MonoStaticMethod(assembly, "ET.MyEntry", "Start");
					start.Run();
					break;
				}
				case CodeMode.ILRuntime:
				{
					...
					IStaticMethod start = new ILStaticMethod(appDomain, "ET.MyEntry", "Start", 0);
					start.Run();
					break;
				}
