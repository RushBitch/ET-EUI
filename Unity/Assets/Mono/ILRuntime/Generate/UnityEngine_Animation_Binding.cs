...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Animation_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, GetClip_1);
            args = new Type[]{typeof(System.String)};
        ...
        static StackObject* GetClip_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
