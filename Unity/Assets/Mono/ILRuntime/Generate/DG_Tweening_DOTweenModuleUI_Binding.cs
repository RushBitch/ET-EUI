...
namespace ILRuntime.Runtime.Generated
{
    unsafe class DG_Tweening_DOTweenModuleUI_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, DOJumpAnchorPos_1);
            args = new Type[]{typeof(UnityEngine.UI.Text), typeof(UnityEngine.Color), typeof(System.Single)};
            method = type.GetMethod("DOColor", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, DOColor_2);
        ...
        static StackObject* DOJumpAnchorPos_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* DOColor_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 3);
