...
namespace ILRuntime.Runtime.Generated
{
    unsafe class SimpleJson_JsonObject_Binding
    {
        ...
        static StackObject* set_Item_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            SimpleJson.JsonObject instance_of_this_method = (SimpleJson.JsonObject)typeof(SimpleJson.JsonObject).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new SimpleJson.JsonObject();
